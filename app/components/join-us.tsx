      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-md mx-auto">
          <div className="space-y-4">
            <Input type="text" placeholder="Your Name" className="bg-gray-800 text-white border-gray-700" onChange={(e: any) => setData({ ...data, name: e.target.value })} />
            <Input type="text" placeholder="Your Day of birth" className="bg-gray-800 text-white border-gray-700" onChange={(e: any) => setData({ ...data, dob: e.target.value })} />
            <Input type="text" placeholder="Your Domicile" className="bg-gray-800 text-white border-gray-700" onChange={(e: any) => setData({ ...data, dom: e.target.value })} />
